...
public class SavingsAccountHelper {
    ...
    public Object depositToSavingsAccountWithPaymentType(final Integer savingsID, final String amount, String date, final int paymentTypeId,
    ...
    public Object withdrawalFromSavingsAccountWithPaymentType(final Integer savingsId, final String amount, String date, final int paymentTypeId,
            String jsonAttributeToGetback) {
