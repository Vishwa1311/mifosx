...
public class ChargesHelper {
    ...
    private static final Integer CHARGE_DEPOSIT_FEE = 11;
    ...
    public static String getSavingsChargesWithAdvancedConfigDataAsJSON(final int paymentTypeId) {
    ...
    public static String getModifiedSavingsChargesWithAdvancedConfigDataAsJSON(final int codeValueId) {
        final HashMap<String, Object> map = populateDefaultsForSavings();
    ...
    public static HashMap getChargeById(final RequestSpecification requestSpec, final ResponseSpecification responseSpec,
        ...
        return Utils.performServerGet(requestSpec, responseSpec, CHARGES_URL + "/" + chargeId + "?template=true&associations=all&" + Utils.TENANT_IDENTIFIER, "");
    }
