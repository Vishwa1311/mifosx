...
public enum ChargeTimeType {
    ...
    DEPOSIT_CHARGE(11, "chargeTimeType.depositCharge"); // only for savings
    ...
    public static Object[] validSavingsValues() {
        return new Integer[] { ChargeTimeType.SPECIFIED_DUE_DATE.getValue(), ChargeTimeType.SAVINGS_ACTIVATION.getValue(),
                ...
                ChargeTimeType.MONTHLY_FEE.getValue(), ChargeTimeType.OVERDRAFT_FEE.getValue(), ChargeTimeType.DEPOSIT_CHARGE.getValue() };
    }
    ...
    public boolean isDepositCharge() {
        return this.value.equals(ChargeTimeType.DEPOSIT_CHARGE.getValue());
    }
    ...
    public boolean isAllowedSavingsChargeTime() {
        return isOnSpecifiedDueDate() || isSavingsActivation() || isSavingsClosure() || isWithdrawalFee() || isAnnualFee()
                || isMonthlyFee() || isOverdraftFee() || isDepositCharge();
    }
