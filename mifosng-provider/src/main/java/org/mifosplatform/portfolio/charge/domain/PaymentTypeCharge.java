...
@Entity
@Table(name = "m_payment_type_charge")
public class PaymentTypeCharge extends AbstractPersistable<Long> {
    ...
    public static PaymentTypeCharge create(final CodeValue paymentType, final Charge charge, final Integer chargeCalculationType, final BigDecimal amount){
